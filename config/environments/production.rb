...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: ENV["APP_HOST"] || "reviewcollector.com" }

  # SMTP settings for SendGrid/Postmark
  ...
  config.action_mailer.smtp_settings = {
    ...
    domain: ENV["APP_HOST"] || "reviewcollector.com"
  }
